...
def test_get_all_business(get_db, get_user_model):
    ...
    assert len(business_services.get_all_business(get_db)) == 1
...
def test_get_all_business_should_return_10(get_db, get_user_model):
    ...
    assert len(business_services.get_all_business(get_db)) == 10
...
def test_get_all_business_should_return_20(get_db, get_user_model):
    ...
    assert len(business_services.get_all_business(get_db)) == 20


def test_get_all_business_should_return_0(get_db, get_user_model):
    # list_business = []
    # for n in range(20):
    #     create_business = business_dtos.BusinessCreateDto(
    #         name=f"name {n} ",
    ...
    assert len(business_services.get_all_business(get_db)) == 0
